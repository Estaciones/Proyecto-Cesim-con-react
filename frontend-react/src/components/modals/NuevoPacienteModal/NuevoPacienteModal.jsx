...
export default function NuevoPacienteModal() {
    ...
    const handleInputChange = (e) => {
        ...
        // Validaciones específicas para CI y teléfono
        if (name === 'ci' || name === 'telefono' || name === 'contacto_emergencia_telefono') {
    ...
    const validateForm = () => {
        ...
        if (formData.contacto_emergencia_telefono && formData.contacto_emergencia_telefono.length < 7) {
            showToast('El teléfono de emergencia debe tener al menos 7 dígitos', 'error');
            return false;
        }
    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className={styles.form}>
                ...
                <div className={styles.formSection}>
                    <h3 className={styles.sectionTitle}>Información de Contacto y Salud</h3>
                    <div className={styles.formGrid}>
                        <div className={styles.formGroup}>
